...
#define TIMERS_TCNT0        (*(( volatile u8 *)0X52))	// Time/Counter0 Register
...
#define TIMERS_TCNT1DATA	(*(( volatile u16*)0X4D))	// Time/Counter1 Register
#define TIMERS_TCNT1H		(*(( volatile u8 *)0X4D))
#define TIMERS_TCNT1L		(*(( volatile u8 *)0X4C))

#define TIMERS_OCR1ADATA	(*(( volatile u16*)0X4B))	// Holds the Compare Value of Timer1 (OC1A / D5)
#define TIMERS_OCR1AH		(*(( volatile u8 *)0X4B))
#define TIMERS_OCR1AL		(*(( volatile u8 *)0X4A))

#define TIMERS_OCR1BDATA	(*(( volatile u16*)0X49))	// Holds the Compare Value of Timer1 (OC1B / D4)
#define TIMERS_OCR1BH		(*(( volatile u8 *)0X49))
#define TIMERS_OCR1BL		(*(( volatile u8 *)0X48))

#define TIMERS_ICR1DATA		(*(( volatile u16*)0X47))	// Used to Define the TOP Value
